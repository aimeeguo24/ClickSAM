...
input_path='Dataset_BUSI/Dataset_BUSI_with_GT'
output_path='data/Dataset_BUSI/Dataset_BUSI_with_GT'
for f in os.listdir(input_path):
    print(f)
    for jk in os.listdir(input_path+f):
        if jk.find(".png") != -1:
            print("yay")
            img = Utils.get_preprocessed_img("{}/{}".format(input_path, jk), IMAGE_SIZE)
            file_name = jk[:jk.find(".png")]
