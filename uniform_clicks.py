...
if __name__ == "__main__":
    ...
    for i in range (0,647):
        x=click_generator((baseline_dir,i,segment_files,anneal_schedule,iou_max
                        ,max_clicks_per_segment,max_clicks_per_kind))
        mp_results.append(x)
        # print(x)
        # print(mp_results)
    # p.close()
